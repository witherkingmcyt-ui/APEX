    ...
    <PageTransition>
      ...
      <section className="relative pt-32 pb-24 lg:pt-48 lg:pb-32 bg-card overflow-hidden border-b border-white/5">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <SectionTitle title="OUR STORY" subtitle="From a vision to Southern California's most competitive travel ball program" />
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            {timeline.map((entry, index) => (
              <div key={entry.id} className={`relative flex flex-col md:flex-row gap-8 mb-16 scroll-animate ${index % 2 === 0 ? "md:flex-row-reverse" : ""}`}>
                ...
                <div className={`w-full md:w-1/2 pl-16 md:pl-0 ${index % 2 === 0 ? "md:pr-16 md:text-right" : "md:pl-16 md:text-left"}`}>
                  <span className="font-display text-5xl text-primary opacity-50 block mb-2">{entry.year}</span>
                  <h4 className="text-2xl font-bold text-white mb-4 uppercase tracking-wide">{entry.heading}</h4>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="scroll-animate">
              ...
              <Link href="/contact"><ApexButton>Get Directions</ApexButton></Link>
            </div>
